...
I used a nvidia network architecture to train my model. <br>

But my model's accuracy was only around 50%. I figured it out the images and steering angle were not right time. <br>
...
I used same architecture as a nvidia architecture. <br>
...
However, I tried to use tensorflow in my raspberry pi to predict a direction of the car. <br>
